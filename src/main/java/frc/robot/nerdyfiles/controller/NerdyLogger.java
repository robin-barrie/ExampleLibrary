 ...
 * @author 
 */
public class NerdyLogger {

	private BufferedWriter writer;
	private boolean logging = true;
	private final String loggerBoolean = "Logging";
	private static NerdyLogger instance;
	...
	public static NerdyLogger getInstance() {
		if (instance == null) {
			instance = new NerdyLogger();
		}
		return instance;
	}
	...
	public void logAll() {
		if (this.wantToLog()) {
			try {
				...
				sb.append(String.format("%f,", Robot.oi.driverJoystick.getRawAxis(1)));
				sb.append(String.format("%f,", Robot.Chassis.getCurrentCommand()));
